...
def compile_main(tools: Tools, info: TargetInfo, cxx_standard: str) -> Path:
...
def parse_arguments() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Fetch, configure, build, install, query, and consume GLM and SDL3."
    )
...
def main() -> int:
    ...
    try:
        ...
        output = compile_main(tools, all_consumer, arguments.std)
